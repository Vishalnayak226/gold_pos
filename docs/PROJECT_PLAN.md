...
*   **Release Model:** Manual, version-flagged releases. The platform owner builds/tests centrally and pushes updates to each tenant on their own schedule; no unattended auto-updater in this phase.
