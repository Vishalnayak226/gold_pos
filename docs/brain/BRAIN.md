...
**Busiest symbols:** `updateEngine.js`, `applyUpdate()`, `checkForUpdates()`, `release_pipeline.js`, `Changelog`, `copyTreeExcludingProtected()`, `fetchVerifiedRelease()`, `[1.2.0] — 2026-08-07`, `[Unreleased]`, `applyPendingUpdate()` … +47
