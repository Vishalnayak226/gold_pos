...
// string (an account name, an error detail), and this override is the one
// place every portal message funnels through. textContent makes that
// structurally un-injectable.
//
...
// anything else on the page can call it. Moved out of customer.html into
// this file so the CSP's scriptSrc no longer needs 'unsafe-inline' (security
// audit C5).
